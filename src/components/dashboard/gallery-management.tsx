  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[1.18fr_0.92fr]">
      <div className="space-y-4">
        <div className="rounded-3xl border border-[var(--border)] bg-[var(--background-secondary)] p-5 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="text-sm font-semibold text-[var(--foreground)]">Catalogo visual</p>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {filteredGallery.map((item) => (
            <article
              key={item.id}
              className={`rounded-3xl border bg-[var(--background-secondary)] shadow-sm transition ${
                selectedId === item.id
            ...
            >
              {item.imagen_url ? (
                ...
                <div className="flex h-48 items-center justify-center rounded-t-3xl bg-[var(--foreground)]">
              ...
              <div className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-[var(--text-muted)]">#{item.orden}</span>
                </div>
                ...
                <div className="mt-3 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="rounded-full border border-[var(--border)] px-4 py-1.5 text-sm font-semibold text-[var(--foreground)] transition hover:bg-[var(--background)]"
                  >
                    Editar
                  </button>
                </div>
      ...
      <aside className="space-y-4">
        ...
        <div className="rounded-3xl border border-[var(--border)] bg-[var(--background-secondary)] p-5 shadow-sm">
          <p className="text-sm font-semibold text-[var(--foreground)]">Proximo paso</p>
